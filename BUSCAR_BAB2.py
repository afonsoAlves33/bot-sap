...
def save_excel_sheet(excel_sheet_name: str, variant: str, code, saving_path: str = r"\\bosch.com\dfsrb\DfsBR\loc\Ca1\ED\mse\MOE1\Dados\Planejamento_Tecnico\19 - Dados_BI_online\03 - Base de dados\teste_bot"):
    """
...
if __name__ == "__main__":
    save_excel_sheet(excel_sheet_name="EXPORT_BAB_2024_consolidado_PPC_BI.XLSX", variant="BAB_EM_2024", code="s_alr_87013625")
